...
export const WeekendSection: React.FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="weekend"
      className="relative min-h-0 py-14 sm:py-20 lg:py-0 lg:h-screen lg:min-h-[740px] lg:max-h-[1080px] w-full overflow-hidden flex items-center justify-center px-4 sm:px-6 lg:px-8 scroll-mt-0 bg-[#d6a978]"
    >
      ...
      <div
        ...
        style={{
          transform: `translate3d(0, ${relScroll * 0.08}px, 0)`,
        }}
      >
        <Image
      ...
      <div
        className="hidden sm:block absolute -top-[5%] inset-x-0 h-[110%] w-full z-10 will-change-transform pointer-events-none"
        style={{
      ...
      >
        <Image
          ...
          sizes="100vw"
          priority
          className="object-contain object-center w-full h-full opacity-60"
        />
      </div>
      ...
      <div
        ...
        style={{
          transform: `translate3d(0, -${relScroll * 0.2}px, 0)`,
        }}
      />
      <div
        ...
        style={{
          transform: `translate3d(-${relScroll * 0.08}px, -${relScroll * 0.2}px, 0)`,
        }}
      />
      <div
      ...
      <div
        className="relative z-20 max-w-5xl mx-auto text-center px-2 xs:px-4 sm:px-6 pt-2 sm:pt-6 pb-2 sm:pb-6 flex flex-col justify-center items-center will-change-transform w-full"
        style={{
          transform: `translate3d(0, -${relScroll * 0.02}px, 0)`,
        }}
      >
        {/* Main Title with Refined Typography */}
        <h2 className="text-2xl xs:text-3xl sm:text-5xl lg:text-6xl font-serif text-[#4a0e17] tracking-tight font-normal leading-[1.15] max-w-2xl mx-auto mb-1.5 sm:mb-2.5">
          A Weekend <br />
          We Will Always Carry
        </h2>

        {/* Lotus Emblem Divider with Fine Gold Flourish */}
        <div className="flex items-center justify-center gap-3 w-full max-w-xs mx-auto my-1.5 sm:my-2 opacity-85">
          <div className="h-[1px] flex-1 bg-gradient-to-r from-transparent via-[#b38e5d]/60 to-[#b38e5d]" />
          <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#b38e5d]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Subtitle */}
        <p className="text-[#3e1f14] text-xs sm:text-sm md:text-base font-serif italic mb-5 sm:mb-8 tracking-wide font-normal">
          Music. Tradition. Family. Blessings.
        </p>

        {/* The Two Improvised Luxury Cards Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 w-full max-w-4xl mx-auto">
          {/* Card 1: Rithanyaa's Sangeeta Upanyasam (Royal Midnight Navy) */}
          <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-b from-[#0e2947] via-[#0b2138] to-[#071625] border border-[#c5a059]/50 shadow-2xl p-5 xs:p-6 sm:p-8 flex flex-col items-center text-center justify-between transition-all duration-500 hover:-translate-y-1.5 hover:shadow-cyan-950/30 hover:border-[#e5c178]">
            ...
            <div className="relative mb-2.5 sm:mb-3.5 z-10">
            ...
            {/* Date & Time Header */}
            <span className="relative z-10 text-[10px] sm:text-[11.5px] font-mono tracking-[0.25em] text-[#d4af37] uppercase font-medium mb-1.5 sm:mb-2.5 drop-shadow-xs">
              JULY 4, 2026 &nbsp;•&nbsp; EVENING
            </span>

            {/* Event Title */}
            <h3 className="relative z-10 text-xl xs:text-2xl sm:text-[28px] lg:text-[31px] font-serif text-[#fdfbf7] tracking-wide leading-[1.25] font-normal mb-2 sm:mb-3">
              Rithanyaa’s <br />
              Sangeeta Upanyasam
            </h3>

            {/* Ornate Inner Divider */}
            <div className="relative z-10 w-3/4 h-[1px] bg-gradient-to-r from-transparent via-[#c5a059]/50 to-transparent my-1.5 sm:my-2" />

            {/* Poetic Subtitle */}
            <p className="relative z-10 text-xs sm:text-[13.5px] font-serif italic text-[#e6d8be]/95 tracking-wide mb-4 sm:mb-6 font-light">
